...
if(isset($_GET['id'])){
    $teacher_edit_digital_ejournal = $_GET['id'];
    ...
    if (isset($_POST['submit'])) { 
        ...
        if (!in_array($extension, ['zip', 'pdf', 'docx'])) {
            ...
            if (move_uploaded_file($file, $destination)) {
                ...
                WHERE (((teacher_mail = '$email') AND (digital_book='e-journal'))) AND (id='$teacher_edit_digital_ejournal')";
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php
                                            echo $row_teacher_digital_ejournal['abstract'];
                                            ?>
                                    </textarea>
                                        </div>
                                        <div class="form-group">
