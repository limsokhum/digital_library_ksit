...
if(isset($_GET['id'])){
    ...
    if(isset($_POST['submit'])){
        ...
        elseif($file!=NULL && $imageName_one==NULL && $imageName_two==NULL){
                ...
                $sql = "UPDATE digitalbook_tb SET title='$title',name_auther='$name_auther',date='$date',advisor='$advisor',select_major='$select_major',digital_book='$digital_book',abstract='$abstract',comment='$comment',keyword='$keyword',image_one='$filesArray_one' WHERE id = $query_edit_digital_book_id";
            }elseif($file==NULL && $imageName_one==NULL && $imageName_two!=NULL){
                ...
                $sql = "UPDATE digitalbook_tb SET title='$title',name_auther='$name_auther',date='$date',advisor='$advisor',select_major='$select_major',digital_book='$digital_book',abstract='$abstract',comment='$comment',keyword='$keyword',image_one='$filesArray_one',image_two='$filesArray_two' WHERE id = $query_edit_digital_book_id";
...
<head>
    ...
    <title>teacher add e-Books</title>
...
if(isset($_GET['id'])){
    ...
    $query_teacher_digital_ebook = "SELECT * FROM digitalbook_tb WHERE (((advisor = '$email') AND (digital_book='e-book'))) AND (id='$edit_teacher_digital_ebook')";
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <input type="hidden" name="advisor" class="form-control form-control"
                                                    id="" value="<?php echo $row_teacher_digital_ebook['advisor']?>">
