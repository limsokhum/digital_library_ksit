                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header d-flex justify-content-between py-3">
                            <a class="m-0 btn btn-primary float-start font-weight-bold text-light" href="e-books.php"><i
                                    class="fa-solid fa-backward"></i> Back</a>
                            <h6 class="m-0 float-end font-weight-bold text-primary">View Digital Book</h6>
                        </div>
