...
if (isset($_POST['submit'])) { 
    ...
    if (!in_array($extension, ['zip', 'pdf', 'docx'])) {
        ...
        if (move_uploaded_file($file, $destination)) {
            $sql = "INSERT INTO digitalbook_tb (title,name_auther,date,image,digital_book,teacher_mail,select_major,abstract,name, size, downloads,view,status) 
            VALUES ('$title','$name_auther','$date','$filesArray','$digital_book','$teacher_mail','$select_major','$abstract','$filename', $size, 0,0,'$status')";
                                ...
                                <form action="" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label class="label-control" for=""
                                            style="font-family:'Koulen', sans-serif;">ប្រធានបទ
