...
if(isset($_POST['teacher_signup'])){
    ...
    if(count($teacher_errors) === 0){
        ...
        $teacher_insert_data = "INSERT INTO teacher_tb (teacher_id,	firstname,	lastname,	teacher_mail,	phone,	select_major,	specialty,	select_role,	teacher_password, image, teacher_detials,	teacher_code,	teacher_status)
                                                values('$teacher_id', '$firstname', '$lastname', '$teacher_email', '$phone', '$select_major', '$specialty', '$select_role', '$teacher_encpass', '$filesArray', '$teacher_detials', '$teacher_code', '$teacher_status')";
