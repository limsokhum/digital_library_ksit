...
if(isset($_GET['id'])){
    $teacher_edit_digital_eproject = $_GET['id'];
    ...
    if (isset($_POST['submit'])) { 
        ...
        if (!in_array($extension, ['zip', 'pdf', 'docx'])) {
            ...
            if (move_uploaded_file($file, $destination)) {
                $sql = "UPDATE digitalbook_tb SET  title='$title',name_auther='$name_auther',
                date='$date',image='$filesArray',digital_book='$digital_book',
                teacher_mail='$teacher_mail',select_major='$select_major',abstract='$abstract',
                name='$filename', size='$size', downloads=0,view=0,status='$status'
                WHERE (((teacher_mail = '$email') AND (digital_book='e-project'))) AND (id='$teacher_edit_digital_eproject')";
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body p-0">
                            ...
                            teacher_tb.teacher_status,teacher_tb.creationdate,major_tb.major_title FROM teacher_tb INNER JOIN major_tb ON teacher_tb.select_major = major_tb.id WHERE teacher_mail = '$email'";
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <input type="input" name="select_major"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <?php
                                            echo $row_teacher_digital_eproject['abstract'];
                                            ?>
                                    </textarea>
                                        </div>
                                        <div class="form-group">
